...
export default function CreateExpenseModal({ visible, onClose, onSave }) {
 ...
 const newErrors = {};
 if (!expenseName.trim()) {
 newErrors.expenseName = t('expenseNameRequired');
 }
 ...
 errors.expenseName ? 'border-red-500' : 'border-slate-200 '
 ...
 } bg-slate-50 text-slate-900 pl-8 pr-4`}
 placeholder="45.00"
 placeholderTextColor="#94a3b8"
 ...
 onPress={handleSave}
 >
 <Text className="text-white font-bold text-base">{t('saveExpense')}</Text>
 </TouchableOpacity>
