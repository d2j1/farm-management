...
export default function TaskSection() {
 ...
 return (
 <View className="p-4">
 <View className="bg-white rounded-2xl shadow-md border border-slate-100 overflow-hidden">
 {/* Header */}
 ...
 <Text className="text-xs text-slate-500 mb-6 text-center max-w-[200px]">
 {t('noTasksDesc')}
 </Text>
 <TouchableOpacity 
 ...
 {/* Footer */}
 <View className="px-5 py-4 bg-slate-50 border-t border-slate-100 gap-2">
