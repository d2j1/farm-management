...
export default function InsightsSection() {
 ...
 <View className="px-4">
 <View className="w-full bg-white rounded-2xl p-6 items-center justify-center border border-slate-100 shadow-sm">
 <View className="h-12 w-12 rounded-full bg-slate-50 items-center justify-center mb-3">
 ...
 <View
 key={insight.title}
 className="w-[220px] bg-white p-3 rounded-xl shadow-sm border border-slate-100 flex-row gap-3"
 >
 ...
 <Text className="text-base font-bold text-slate-900 leading-tight">{insight.title}</Text>
 <Text className="text-sm text-slate-500 mt-1 leading-relaxed" numberOfLines={2}>
 {insight.description}
 </Text>
 </View>
 </View>
