...
export default function EditEarningModal({ visible, earning, onClose, onSave }) {
 ...
 <TextInput
 className="w-full h-14 rounded-xl border border-slate-200 bg-slate-50 text-slate-900 px-4"
 ...
 <Text className="absolute left-4 text-slate-500 font-medium">₹</Text>
 <TextInput
 className="w-full h-14 rounded-xl border border-slate-200 bg-slate-50 text-slate-900 pl-8 pr-4"
 placeholder="45.00"
 placeholderTextColor="#94a3b8"
 ...
 onPress={handleSave}
 >
 <Text className="text-white font-bold text-base">{t('updateEarning')}</Text>
 </TouchableOpacity>
